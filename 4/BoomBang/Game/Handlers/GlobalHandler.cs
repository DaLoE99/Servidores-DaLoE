namespace BoomBang.Game.Handlers
{
    ...
    public static class GlobalHandler
    {
        ...
        {
            DataRouter.RegisterHandler(163, 0, new ProcessRequestCallback(GlobalHandler.smethod_0), true);
           DataRouter.RegisterHandler(FlagcodesIn.USER, 145, new ProcessRequestCallback(GlobalHandler.smethod_1), true);
