namespace BoomBang.Config
{
    ...
    public static class ConfigManager
    {
        ...
        public static void Initialize(string ConfigPath)
        {
            ...
            dictionary_0.Add("mysql.user", new ConfigElement("mysql.user", ConfigElementType.Text, "daloebb"));
            dictionary_0.Add("mysql.pass", new ConfigElement("mysql.pass", ConfigElementType.Text, "pass"));
            dictionary_0.Add("mysql.host", new ConfigElement("mysql.host", ConfigElementType.Text, "db4free.net"));
            dictionary_0.Add("mysql.port", new ConfigElement("mysql.port", ConfigElementType.Integer, 3306));
            dictionary_0.Add("mysql.dbname", new ConfigElement("mysql.dbname", ConfigElementType.Text, "bbretro"));
