namespace BoomBang.Game.FlowerPower
{
    ...
    public static class FlowerPowerManager
    {
        public static void Initialize()
        {
            ...
            DataRouter.RegisterHandler(FlagcodesIn.USER, ItemcodesIn.UNKNOW1, new ProcessRequestCallback(Unknow1), false);
        ...
        {
            //±x³“³x³²1³²4294967295³²-1³²°
            ServerMessage message = new ServerMessage(ItemcodesIn.UNKNOW1);
            message.AppendParameter(1);
            message.AppendParameter(4294967295);
            message.AppendParameter(-1);
