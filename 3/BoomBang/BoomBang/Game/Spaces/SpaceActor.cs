namespace BoomBang.Game.Spaces
{
    ...
    using BoomBang.Game.Pathfinding;
    ...
    public class SpaceActor
    {
        ...
        /* private scope */ bool bool_2;
        /* private scope */ bool bool_3;
        /* private scope */ bool bool_4;
        /* private scope */ bool bool_5;
        /* private scope */ bool bool_6;
        /* private scope */ Dictionary<string, string> dictionary_0;
        ...
        /* private scope */ BoomBang.Game.Pathfinding.Pathfinder pathfinder_0;
        internal SpaceActorType spaceActorType_0;
        /* private scope */ SpaceInstance spaceInstance_0;
        internal uint uint_0;
        internal uint uint_1;
        /* private scope */ Vector2 vector2_0;
        internal Vector3 vector3_0;
        /* private scope */ Vector3 vector3_1;
        ...
        private void method_0(SqlDatabaseClient sqlDatabaseClient_0)
        {
            ...
            else if (this.int_2 >= 5)
            {
                ...
                SessionManager.GetSessionByCharacterId(info.UInt32_0);
            }
        }
        ...
        private void method_3(object sender, ElapsedEventArgs e)
        {
            if (!this.IsLocked && this.bool_3)
            {
                ...
                {
                    sessionByCharacterId.SendData(SpaceUserSendUppercut.RemoveComposer(), false);
                }
            }
        }
        ...
        public void Whisper(string MessageText, uint TargetUserId, bool CanOverridespaceMute = false)
        {
            ...
            if (this.spaceActorType_0 == SpaceActorType.UserCharacter)
            {
                ...
                if (sessionByCharacterId != null)
                {
                    sessionByCharacterId.SendData(message, false);
                }
            }
            if (TargetUserId != this.uint_1)
            {
                ...
                if ((actorByReferenceId != null) && (actorByReferenceId.Type == SpaceActorType.UserCharacter))
                {
                    ...
                    {
                        session2.SendData(message, false);
                    }
                }
            }
        }
        ...
        public BoomBang.Game.Pathfinding.Pathfinder Pathfinder
        {
            get
            {
