namespace BoomBang
{
    ...
    public static class Output
    {
        ...
        public static void WriteBanner()
        {
            ...
            foreach (string str in new List<string> { " ", "  ______                     ______                           ", @"  | ___ \                    | ___ \                        ", "  | |_/ /___  ___  _ __ ___  | |_/ / __ _ _ __   ___          ", @"  | ___\/ _ \/ _ \| '_ ` _ \ | ___ \/ _` | '_ `./ _ \    Retro de BoomBang", "  | |_/  (_)  (_) | | | | | || |_/ | (_| | | | | (_)|    Development version", @"  \____/\___/\___/|_| |_| |_|\____/\,__|_|_| |_|\__ |    Hecho por DaLoE & Kyle", "                                                  |_|    DaLoE", "" })
            {
