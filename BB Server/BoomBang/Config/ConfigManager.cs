...
namespace Snowlight.Config
{
    public static class ConfigManager
    {
        ...
        public static void Initialize(string ConfigPath)
        {
            ...
            mConfigData.Add("mysql.pass", new ConfigElement("mysql.pass", ConfigElementType.Text, "password"));
            ...
            mConfigData.Add("mysql.dbname", new ConfigElement("mysql.port", ConfigElementType.Text, "boombang1"));
            // Net
            ...
            mConfigData.Add("net.bind.port", new ConfigElement("net.bind.port", ConfigElementType.Integer, 2001));
