namespace BoomBang.Config
{
    ...
    public static class ConfigManager
    {
        ...
        public static void Initialize(string ConfigPath)
        {
            ...
            dictionary_0.Add("mysql.user", new ConfigElement("mysql.user", ConfigElementType.Text, "root"));
            dictionary_0.Add("mysql.pass", new ConfigElement("mysql.pass", ConfigElementType.Text, "changeme"));
            ...
            dictionary_0.Add("mysql.dbname", new ConfigElement("mysql.port", ConfigElementType.Text, "boombang"));
