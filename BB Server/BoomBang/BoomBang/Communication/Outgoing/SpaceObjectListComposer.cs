namespace BoomBang.Communication.Outgoing
{
    ...
    public static class SpaceObjectListComposer
    {
        public static ServerMessage BroadcastCompose(SpaceActor Actor)
        {
            ServerMessage message = new ServerMessage(FlagcodesOut.SPACES, ItemcodesOut.SPACES_POST_USER, false);
        ...
        {
            ServerMessage message = new ServerMessage(FlagcodesOut.SPACES, ItemcodesOut.SPACES_LOAD_USERS, true);
