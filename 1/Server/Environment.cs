    ...
    class Environment
    {
        ...
        public static void InitMySQL()
        {
            try
            {
                ...
                DatabaseServer bDatabaseServer = new DatabaseServer("db4free.net", 3306, "daloebbang", "pass");//3306 = mysql

                Database bDatabase = new Database("retrobang", 0, 450);

                mDatabaseManager = new DatabaseManager(bDatabaseServer, bDatabase);
                mDatabaseManager.SetClientAmount(1);
        ...
        public static void Initialize()
        {
            ...
            Console.WriteLine("Skype: daloebb || Twitter: @boombangdaloe");
            Console.WriteLine("");
            Console.WriteLine("");
