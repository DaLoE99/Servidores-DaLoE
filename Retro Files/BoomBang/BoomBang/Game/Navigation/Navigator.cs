namespace BoomBang.Game.Navigation
{
    using BoomBang;
    ...
    class Navigator
    {
        ...
        public static void Initialize(SqlDatabaseClient MySqlClient)
        {
            ...
            DataRouter.RegisterHandler(FlagcodesIn.NAVIGATOR, ItemcodesIn.NAVIGATOR_ITEMS, new ProcessRequestCallback(Navigator.smethod_5), false);
            DataRouter.RegisterHandler(FlagcodesIn.NAVIGATOR, ItemcodesIn.NAVIGATOR_SUBITEMS, new ProcessRequestCallback(Navigator.smethod_6), false);
        }
